...
import {Button, Grid, IconButton, List, ListItem, ListItemText, ListItemSecondaryAction, Paper, TextField} from '@material-ui/core';
            ...
            <Paper style={{margin: '24px auto', maxWidth: '800px', padding: '12px'}} >
                <Grid container spacing={2} >
                    ...
                    <Grid item xs={12} container spacing={2} >
                        ...
                        <Grid item xs={2} >
                            <Button onClick={addIngredient} variant={'outlined'}>Adicionar</Button>
                        </Grid>
                    </Grid>
                    ...
                    <Grid item xs={12} container justify={'center'} spacing={2}>
                        ...
                        <Grid item >
                            <Button onClick={addRecipe} color="primary" variant="contained">Cadastrar</Button>
                        </Grid>
                    </Grid>
